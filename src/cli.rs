...
pub fn build_cli() -> Command<'static> {
    Command::new("rmbrs")
        ...
        .subcommand(Command::new("print").about("Print everything remembered"))
        .subcommand(
            Command::new("todos")
                .about("Things to do")
                .subcommand(
                    Command::new("add")
                        ...
                        .arg(Arg::new("todo").takes_value(true).help("Todo item to add"))
            ...
            Command::new("links")
                ...
                .subcommand(
                    Command::new("add")
                        ...
                        .arg(Arg::new("link").takes_value(true).help("Link to add"))
                        .arg_required_else_help(true),
                )
                .subcommand(
                    Command::new("rm")
            ...
            Command::new("timers")
                ...
                .subcommand(
                    Command::new("add")
                        ...
                        .arg(Arg::new("what").takes_value(true).help("What to do"))
                        .arg(Arg::new("when").takes_value(true).help("When to do it"))
                        .arg_required_else_help(true),
                )
                .subcommand(
                    Command::new("rm")
